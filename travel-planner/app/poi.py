...
class MockPoiProvider(PoiProvider):
    ...
    _KNOWN = {
        "西安": [
            ("秦始皇帝陵博物院(兵马俑)", "临潼区秦陵北路", "博物馆", 120, 4.9, "08:30-18:00", 109.27, 34.38),
            ("大雁塔·大慈恩寺", "雁塔区雁塔南路", "人文古迹", 50, 4.7, "08:00-17:30", 108.96, 34.22),
        ...
        "杭州": [
            ...
            ("西溪国家湿地公园", "西湖区天目山路518号", "公园", 80, 4.6, "08:30-17:30", 120.06, 30.28),
